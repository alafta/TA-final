...
public class AdapterCm extends RecyclerView.Adapter<AdapterCm.ViewHolder> {
    ...
    public AdapterCm(Context context, ArrayList<PrinsipalSolusi> listPrinsipalSolusi, ArrayList<PenjelasanPrinsipalSolusi> penjelasan_ps, RecyclerViewInterfaceCm recyclerViewInterfaceCm) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterCm.ViewHolder holder, int position) {
