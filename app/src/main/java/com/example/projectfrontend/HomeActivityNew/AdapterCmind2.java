...
public class AdapterCmind2 extends RecyclerView.Adapter<AdapterCmind2.ViewHolder> {
    ...
    AdapterCmind2(Context context, ArrayList<PrinsipalSolusi> listPrinsipalSolusi, ArrayList<PenjelasanPrinsipalSolusi> penjelasan_ps, RecyclerViewInterfaceCm2 recyclerViewInterfaceCm2) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(view, listPrinsipalSolusi, listPenjelasanPrinsipalSolusi, recyclerViewInterfaceCm2);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, ArrayList<PrinsipalSolusi> prinsipalSolusi, ArrayList<PenjelasanPrinsipalSolusi> listPenjelasan, RecyclerViewInterfaceCm2 recyclerViewInterfaceCm2) {
            super(itemView);
